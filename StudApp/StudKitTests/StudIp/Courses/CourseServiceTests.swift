...
final class CourseServiceTests: XCTestCase {
    ...
    override func setUp() {
        ...
        try! FileResponse(folderId: "file.pdf", fileId: "4594bd27b2c3f5b", filename: "file.pdf",
                          coursePath: "$e894bd27b2c3f5b25e438932f14b60e1", title: "File").coreDataModel(in: context)
