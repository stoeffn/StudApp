...
extension FileModelTests {
    static let folder = FileModel(folderId: "0", coursePath: "\\/api.php\\/course\\/0", children: [FileModelTests.document],
                                  title: "Folder", ownerPath: "\\/api.php\\/user\\/Array")

    static let document = FileModel(fileId: "1", name: "image.png", coursePath: "\\/api.php\\/course\\/0", parentId: "0",
